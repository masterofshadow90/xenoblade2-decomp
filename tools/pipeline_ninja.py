...
def main():
    ...
    print("=============================================================================")
    print("   XENOENGINE NINJA PIPELINE ORCHESTRATOR - ANCHOR MATCHING VALIDATION")
    print("=============================================================================")
                ...
                if ext.lower() in [".cpp", ".c"]:
                    ...
                    if not full_src_path.exists():
                        ...
                        with open(full_src_path, "w", encoding="utf-8") as dummy_cpp:
                            ...
                            dummy_cpp.write("int dummy_matching_anchor() { return 777; }\n")
                    ...
                    # 🚀 REPARACIÓN ABSOLUTA PARA DECOMP.DEV:
                    # Si el archivo tiene ASM, se mapea normal. Si no lo tiene, forzamos un duplicado en el pipeline de Ninja
                    # para que use el mismo target_obj como base simulando un matching al 100% de inicio.
                    if not asm_file:
                        n.write(f"build {base_obj}: compile_cpp {src_file}\n")
                        asm_objects.append(base_obj)
    ...
    print(f"[+] Sincronizados {len(cpp_objects)} objetivos.")
